...
const ExamModel = {
  ...
  getUserExamDataFocus: async (getUserExamData) => {
    const connection = await pool.getConnection();

    let exam_table = "";

    if (getUserExamData.practice_exam === "1") {
      exam_table = "practice_exam_1_focus";
    } else if (getUserExamData.practice_exam === "2") {
      exam_table = "practice_exam_2_focus";
    } else {
      exam_table = "practice_exam_3_focus";
    }
  ...
  storeExamDataFocus: async (storeExamData) => {
    const connection = await pool.getConnection();
    let exam_table = "";
